...
- Three Main Screens: A clear user flow, including a Start Screen, the main Game Screen, and a Game Over Screen.

- Player Control: Spacebar input is used for the Alpaca to jump over obstacles.
...
- Game Logic & Entities:
    ...
    - Power-up: Donuts act as a power-up, granting the player extra lives upon consumption.
...
1. START: The initial state. Displays the logo/title and a "Start Game" button. Transitions to **GAME**.
